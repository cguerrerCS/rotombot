...
ServerConfig.prototype.getOptionsAsConfigured = function () { return this.gymLookupOptions; };
ServerConfig.prototype.getEffectiveOptions = function () { return this.normalized.gymLookupOptions; };
...
ServerConfigManager.prototype.addServer = function (init) {
...
ServerConfigManager.prototype.tryGetServer = function (name) {
    if (!this.byId[name]) {
