 ...
 */
RaidManager.prototype.formatRaidList = function (raids, filterDescription) {
    ...
    for (let i = 0; i < raids.length; i++) {
        let raid = RaidManager.getFormattedRaidDescription(raids[i]);
...
RaidManager.prototype.listFormatted = function (filter, filterDescription) {
    ...
    return this.formatRaidList(raids, filterDescription);
};
