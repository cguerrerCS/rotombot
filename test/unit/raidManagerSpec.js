...
const bosses = [
    { name: "Latias", id: 123, tier: "Tier 5", image: "t5.png", status: "active" },
    { name: "Kyogre", id: 123, tier: "Tier 5", image: "t5.png", status: "active" },
    { name: "Ho-oh", id: 123, tier: "Tier 5", image: "t5.png", status: "active" },
    { name: "Zapdos", id: 123, tier: "Tier 5", image: "t5.png", status: "inactive" },
    { name: "Houndoom", id: 123, tier: "Tier 4", image: "t4.png", status: "active" },
    { name: "Tyranitar", id: 123, tier: "Tier 4", image: "t4.png", status: "active" },
    { name: "Aggron", id: 123, tier: "Tier 4", image: "t4.png", status: "active" },
    { name: "Absol", id: 123, tier: "Tier 4", image: "t4.png", status: "active" },
    { name: "Walrein", id: 123, tier: "Tier 4", image: "t4.png", status: "active" },
    { name: "Machamp", id: 123, tier: "Tier 3", image: "t3.png", status: "active" },
    { name: "Gengar", id: 123, tier: "Tier 3", image: "t3.png", status: "active" },
    { name: "Jynx", id: 123, tier: "Tier 3", image: "t3.png", status: "active" },
    { name: "Pinsir", id: 123, tier: "Tier 3", image: "t3.png", status: "active" },
    { name: "Granbull", id: 123, tier: "Tier 3", image: "t3.png", status: "active" },
    { name: "Piloswine", id: 123, tier: "Tier 3", image: "t3.png", status: "active" },
    { name: "Exeggutor", id: 123, tier: "Tier 2", image: "t2.png", status: "active" },
    { name: "Misdreavus", id: 123, tier: "Tier 2", image: "t2.png", status: "active" },
    { name: "Sneasel", id: 123, tier: "Tier 2", image: "t2.png", status: "active" },
    { name: "Sableye", id: 123, tier: "Tier 2", image: "t2.png", status: "active" },
    { name: "Mawile", id: 123, tier: "Tier 2", image: "t2.png", status: "active" },
    { name: "Magikarp", id: 123, tier: "Tier 1", image: "t1.png", status: "active" },
    { name: "Wailmer", id: 123, tier: "Tier 1", image: "t1.png", status: "active" },
    { name: "Swablu", id: 123, tier: "Tier 1", image: "t1.png", status: "active" },
    { name: "Shuppet", id: 123, tier: "Tier 1", image: "t1.png", status: "active" },
    { name: "Duskull", id: 123, tier: "Tier 1", image: "t1.png", status: "active" },
    { name: "Snorunt", id: 123, tier: "Tier 1", image: "t1.png", status: "active" },
];

const badBosses = [
    { Name: "Latias", id: 123, tier: "Tier 5" },
...
const gymSpecs = [
    ...
    ["0123456789", "Rain City", "Redmond", "Cleveland Fountain", "Cleveland Fountain", 47.673667, -122.125595, "NonEx"],
    ["0123456789", "Rain City", "Redmond", "Gridlock Light Sculpture", "Gridlock", 47.673298, -122.125256, "ExEligible"],
    ["0123456789", "Rain City", "Redmond", "Painted Parking Lot", "Painted Parking Lot", 47.672712, -122.124617, "ExEligible"],
    ["0123456789", "Rain City", "Redmond", "Redmond Town Center Fish Statue", "Farmers Market", 47.671892, -122.124425, "ExEligible"],
    ["0123456789", "Rain City", "Redmond", "Redmond Clock Tower",  "Clock Tower", 47.674170,  -122.123056, "NonEx"],
    ["0123456789", "Rain City", "Redmond", "Victors Coffee Co. and Roasters",  "Victors Coffeeshop", 47.674577,  -122.121900, "NonEx"],
    ["0123456789", "Rain City", "Redmond", "Redmond's Erratic",  "Redmond Erratic", 47.671955,  -122.119251, "NonEx"],
    ["0123456789", "Rain City", "Redmond", "Kids Playing Baseball Mural",  "Mattress Firm", 47.672620,  -122.116819, "NonEx"],
    ["0123456789", "Rain City", "Redmond", "BJ's Brewmural", "BJs Brewhouse", 47.668914,  -122.119748, "NonEx"],
    ["0123456789", "Rain City", "Redmond", "Mural (Wells Fargo)", "Wells Fargo", 47.678650,  -122.127309, "NonEx"],
    ["0123456789", "Rain City", "Redmond", "Wisdom Seekers in Redmond", "Redmond Library", 47.678799,  -122.128532, "NonEx"],
    ["0123456789", "Rain City", "Redmond", "Luke McRedmond's Paired Beavers", "Luke McRedmond", 47.673250,  -122.132160, "NonEx"],
    ["0123456789", "Rain City", "Redmond", "Soulfood Books and Cafe", "Soul Foods", 47.675219,  -122.130386, "NonEx"],
    ["0123456789", "Rain City", "Redmond", "West Ironcycle", "Ben Franklin", 47.675691,  -122.130123, "NonEx"],
    ["0123456789", "Rain City", "Redmond", "Hunting Fox", "city Hall", 47.678920,  -122.130520, "NonEx"],
    ["0123456789", "Rain City", "Redmond", "Weiner Elephants", "Redmond PD", 47.680386,  -122.128889, "NonEx"],
    ["0123456789", "Rain City", "Redmond", "Portal II", "Portal 2", 47.680447,  -122.131723, "NonEx"],
    ["0123456789", "Rain City", "Redmond", "The Last Test", "Last Test", 47.682691,  -122.132021, "NonEx"],
    ["0123456789", "Rain City", "Redmond", "Community Rockstars", "Community Rockstars", 47.683612,  -122.132734, "NonEx"],
    ["0123456789", "Rain City", "Redmond", "Redmond Twist", "Evergreen", 47.681979,  -122.123692, "NonEx"],
    ["0123456789", "Rain City", "Redmond", "Mysterious Hatch", "Reservoir Park", 47.685378,  -122.122394, "NonEx"],
    ["0123456789", "Rain City", "Redmond", "Nike Park", "Nike Park", 47.683823,  -122.110841, "NonEx"],
    ["0123456789", "Rain City", "Redmond", "St. Jude Walking Trail", "St Judes", 47.693495,  -122.116883, "NonEx"],
    ["0123456789", "Rain City", "Redmond", "Redmond Meadow Park", "Meadow Park", 47.695703,  -122.126550, "NonEx"],
    ["0123456789", "Rain City", "Redmond", "Leaf Inlay in Sidewalk", "Leaf Inlay", 47.689362,  -122.114435, "NonEx"],
    ["0123456789", "Rain City", "Redmond", "The Church Of Jesus Christ Of Latter-Day Saints (Hartman Park)", "LDS (Hartman Park)", 47.690909,  -122.110964, "NonEx"],
    ["0123456789", "Rain City", "Redmond", "Hartman Park", "Hartman Park Sign", 47.691002,  -122.110177, "NonEx"],
    ["0123456789", "Rain City", "Redmond", "Jim Palmquist Memorial Plaque", "Hartman Park (Baseball)", 47.692436,  -122.107328, "NonEx"],
    ["0123456789", "Rain City", "Redmond", "Redmond Pool", "Redmond Pool", 47.692516,  -122.106308, "NonEx"],
    ["0123456789", "Rain City", "Redmond", "Bear Creek Water Tower", "Bear Creek Water Tower", 47.687974,  -122.103674, "NonEx"],
    ["0123456789", "Rain City", "Redmond", "Education Hill Pig", "Education Hill Pig", 47.674945,  -122.111546, "NonEx"],
    ["0123456789", "Bellevue", "Bellevue", "Find shiny deals at sprint", "Bellevue Sprint (fake)", 47.622703, -122.1625050, "NonEx"],
    ["0123456789", "Rain City", "Redmond", "Find shiny deals at Sprint", "Redmond Sprint", 47.670882, -122.114047, "ExEligible"],
...
describe("raidManager", () => {
    ...
    describe("raidListRefresh method", () => {
        ...
        it("should move hatched eggs to active raid with expected boss if only one boss is valid", () => {
            let myBosses = [{ id: 123, name: "Latias", tier: "Tier 5", image: "t5.png", status: "active" }];
